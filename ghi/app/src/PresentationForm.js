                ...
                <div className="offset-3 col-6">
                    <div className="shadow p-4 mt-4">
                        ...
                        <form onSubmit={this.handleSubmit} id="create-presentation-form">
                            ...
                            <div className="form-floating mb-3">
                                <input onChange={this.handleTitleChange} vlaue={this.state.title} placeholder="Title" required type="text" name="title" id="title"
                                    className="form-control" />
                            ...
                            <div className="mb-3">
                                <select onChange={this.handleConferenceSelection} value={this.state.conference} required name="conference" id="conference" className="form-select">
